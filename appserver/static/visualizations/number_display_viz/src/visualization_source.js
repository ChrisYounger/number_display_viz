...
// Then set borders around the place to be a few shades darker than the elem 
                        ...
                        '<rect x="5" y="5" width="90" height="90" class="number_display_viz-fill_primary" fill="#ffffff" />' +
                        '</svg>').appendTo(viz.$wrapc2);

                    } else if (viz.config.style === "a2") { // square
                        viz.$svg = $('<svg width="100%" height="100%" mlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="60 80 280 280" style="filter: drop-shadow(rgba(0, 0, 0, 0.5) 0px 0px 10px);">'+
                        '<path d="M100,100 h200 a20,20 0 0 1 20,20 v200 a20,20 0 0 1 -20,20 h-200 a20,20 0 0 1 -20,-20 v-200 a20,20 0 0 1 20,-20 z" class="number_display_viz-fill_primary" fill="#ffffff" />' +
                        '</svg>').appendTo(viz.$wrapc2);
                        ...
                        '<rect x="5" y="5" width="90" height="45" class="number_display_viz-fill_primary" fill="#ffffff" />' +
                        '</svg>').appendTo(viz.$wrapc2);

                    } else if (viz.config.style === "a4") { // rect 2
                        viz.$svg = $('<svg width="100%" height="100%" mlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 240 160" style="filter: drop-shadow(rgba(0, 0, 0, 0.5) 0px 0px 10px);">'+
                        '<path d="M0,10 h240 a20,20 0 0 1 20,20 v100 a20,20 0 0 1 -20,20 h-240 a20,20 0 0 1 -20,-20 v-100 a20,20 0 0 1 20,-20 z" class="number_display_viz-fill_primary" fill="#4fa484"></path>'+
                        '</svg>').appendTo(viz.$wrapc2);
                        ...
                        '<circle cx="55" cy="55" r="40" class="number_display_viz-fill_primary" fill="#ffffff" />' +
                        '</svg>').appendTo(viz.$wrapc2);
                        ...
                        '<path d="M 50 10 A 40 40 0 1 0 50 90 A 40 40 0 1 0 50 10 Z M 50 30 A 20 20 0 1 1 50 70 A 20 20 0 1 1 50 30 Z" class="number_display_viz-fill_primary" fill="#ffffff" />' +
                        '</svg>').appendTo(viz.$wrapc2);
                        ...
                        'M 50 15 '+
                        'A 35 35 0 1 1 50 85 '+
                        'A 35 35 0 1 1 50 15 Z" class="number_display_viz-fill_primary" fill="#ffffff" />' +
                        '</svg>').appendTo(viz.$wrapc2);
        ...
        getColorFromMode: function(mode, color1, color2) {
            var viz = this;
            if (mode === "darker1") {
                return viz.lightenDarkenColor(color2, -30);
            } else if (mode === "darker2") {
                return viz.lightenDarkenColor(color2, -60);
